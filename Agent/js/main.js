(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    const showModal = () => {
        ...
        downloadLink.href = 'path/to/your/qr-code-image.png';
    ...
    // Find all "Scan QR Code" links and add a click event
    const scanQrCodeLinks = document.querySelectorAll('a');
    scanQrCodeLinks.forEach((link) => {
        if (link.textContent === 'Scan QR Code') {
